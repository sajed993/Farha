/* ================= state ================= */
let S={lang:'ar',view:'land',filter:'all',pmFilter:'all',rdFilter:'all',design:null,cart:0,tier:'prem',extras:[],
 c:{t:'',n:'',d:'',p:'',m:'',when:'',maps:'',qr:false,font:0,pal:0,anim:0,music:1,autoplay:true,musicStart:'open',
